 ...
 */
require_once __DIR_EDI__ . 'EDI/Common/Parser.php';
require_once __DIR_EDI__ . 'EDI/Common/Utils.php';
require_once __DIR_EDI__ . 'EDI/EDIFACT/Elements.php';
require_once __DIR_EDI__ . 'EDI/EDIFACT/MappingProvider.php';
...
class EDI_EDIFACT_Parser extends EDI_Common_Parser
{
     ...
     */
    public function parseString($edistring, $msgtype = NULL)
    {
        ...
        $this->interchange[] = $this->parseSegment('UNB', 
            $tokens['interchangeHeader'], true);
        ...
        $this->interchange[] = $this->parseSegment('UNZ', 
            $tokens['interchangeTrailer'], true);
