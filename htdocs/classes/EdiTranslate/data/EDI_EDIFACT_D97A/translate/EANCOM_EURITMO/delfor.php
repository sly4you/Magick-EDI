			...
			switch ($attuale)
			{
				...
				case "delfor>gis_group>sg12_group>loc":
					...
					switch ($this->valori["delfor>gis_group>sg12_group>loc>e3227"])
					{
						...
						'9048'=>strlen($this->valori["delfor>gis_group>sg12_group>loc>c517>e3055"]) ? $this->valori["delfor>gis_group>sg12_group>loc>c517>e3055"]: "92",
						);
						break;
				...
				switch ($this->valori["delfor>gis_group>sg12_group>sg17_group>sg18_group>qty>c186>e6063"])
				{
					case "1":
						...
						$this->valori['schedulazioni'][$cnt]['quantita_tipo'] = $this->valori["delfor>gis_group>sg12_group>sg17_group>sg18_group>qty>c186>e6063"];
						break;
				...
				switch ($this->valori["delfor>gis_group>sg12_group>sg17_group>sg18_group>dtm>c507>e2005"])
				{
					case "2":
						...
						$this->valori['schedulazioni'][$cnt]['dataConsegna'] = $this->valori["delfor>gis_group>sg12_group>sg17_group>sg18_group>dtm>c507>e2380"];
						$this->valori['schedulazioni'][$cnt]['tipo_data'] = $this->valori["delfor>gis_group>sg12_group>sg17_group>sg18_group>dtm>c507>e2005"];
						//FIXME gestire la conversione della data

					default:
						$this->myLog ("$attuale : rilevato valore tipo data non gestito ". $this->valori["delfor>gis_group>sg12_group>sg17_group>sg18_group>qty>c507>e2005"]);
						break;
				}
				break;
				...
				if(is_array($this->valori['schedulazioni']))
				{
					foreach( $this->valori['schedulazioni'] as $s )
					{
						...
						// Ignoro quantita' di tipi <> 1 e tipo di DTM diverso da 2
						if ($s['quantita_tipo'] != "1")
						continue;
