...
try {
	//$parser= new EDI(dirname(__FILE__) . '/examples/desadv-1.edi');
	//$parser->ediTranslateTo('EDIFACT','D97A');
	
	//$parser= new EDI(dirname(__FILE__) . '/examples/desadv-2.edi');
	//$parser->ediTranslateTo('EDIFACT','D96A');

	// $parser= new EDI(dirname(__FILE__) . '/examples/delfor-new.edi');
	// $parser->ediTranslateTo('EANCOM','EURITMO');

	//$parser= new EDI(dirname(__FILE__) . '/examples/delfor-3.edi');
	//$parser->ediTranslateTo('EANCOM','EURITMO');
